...
export class Config {
    ...
    public static API: any = {
        ...
        //  SAVE_SURVEY: Config.BASE_POINT_API + 'save_new_survey',
         ...
         FETCH_RESOURCE_LIST:Config.BASE_POINT_API +'listing_resource_upload_file',
         UPLOAD_RESOURCES:Config.BASE_POINT_API +'save_resource_upload_file',
         DELETE_RESOURCE_FILE:Config.BASE_POINT_API +'delete_resource_file',
         DOWNLOAD_RESOURCE_FILE:Config.BASE_POINT_API +'resource_download',
         PREVIEW_RESOURCE_PATH:Config.BASE_POINT_API +'get_file_content',
        ...
        //Config Rules
          GET_RULES_LIST: Config.BASE_POINT_API + 'list_rules',
          GET_DEFAULT_SUGGESTION: Config.BASE_POINT_API + 'get_rule_constant',
          GET_PARAMETER_DATA: Config.BASE_POINT_API + 'get_parameter_list_survey_type',
          GET_RULE_PARAMETER: Config.BASE_POINT_API + 'get_all_parameter_survey_type',
          SAVE_RULE: Config.BASE_POINT_API + 'save_rule',
          DELETE_RULE: Config.BASE_POINT_API + 'delete_rule',
        ...
        // Project Listing 
         ...
         GET_SCATTER_DATA: Config.BASE_POINT_VIZ_API + 'scatter_plot',

         //Simulate Component
         SIMULATE_DEFAULT_FILTERS: Config.BASE_POINT_VIZ_API + 'list_all_simulation',
         GET_RESISTIVY_DATA:  Config.BASE_POINT_VIZ_API + 'fetch_zones',
         START_SIMULATION: Config.BASE_POINT_VIZ_API + 'simulate',
         ...
         SIMULATE_BEASY_WS: Config.BASE_POINT_VIZ_API + 'ws/beasy', //(Web Socket Connection)
         ...
         // Upload Services
         DOWNLOAD_TEMPLATE_DATA: Config.BASE_POINT_API + 'download_template',
         PREVIEW_TEMPLATE_DATA: Config.BASE_POINT_API + 'preview_template ',
         SAVE_TEMPLATE_DATA: Config.BASE_POINT_API + 'upload_template'
    ...
    public static CONSTANTS: any = {
      ...
      public static PROJECTCONSTANTS: any = {
        ...
        import_data: [
          ...
          {
            label: 'Simulation Profiles',
            value: 'simulation_profiles',
            key: 'simulate'
          },
          {
